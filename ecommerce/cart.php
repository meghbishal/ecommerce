    ...
    <div class="row">
      <form action="" method="post">
        <table class="table table-bordered text-center">
              ...
              <!-- Php code to display data of cart-->
              <?php
              $get_ip = getIPAddress();
              $total_price=0;
                ...
                <tr>
                   ...
                   <?php
                     ...
                     if(isset($_POST['update_cart'])){
                      ...
                      $update_cart="Update `cartdetails` set quantity=$quantities where ip_address='$get_ip'";
                      $result_products_qantity=mysqli_query($con,$update_cart);
...
function remove_cart_items(){
  ...
  if(isset($_POST['remove_cart'])){
    foreach($_POST['removeitem'] as $remove_id){
      echo $remove_id;
      $delete_query="Delete from `cartdetails` where product_id=$remove_id";
