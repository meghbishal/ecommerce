...
if(isset($_GET['add_to_cart'])){
  ...
  $select_query="Select * from `cartdetails` where ip_address='$get_ip' and product_id=$get_product_id";
  $result_query=mysqli_query($con,$select_query);
  $num_of_rows=mysqli_num_rows($result_query);
  if($num_of_rows>0){
    ...
    echo"<script>window.open('index.php','_self')</script>";
        ...
        $insert_query="insert into `cartdetails`(product_id,ip_address,quantity) values($get_product_id,'$get_ip',0)";
...
function cart_item()
{
  if(isset($_GET['add_to_cart'])){
    global $con;
    $get_ip = getIPAddress();
    $select_query="Select * from `cartdetails` where ip_address='$get_ip'";
    $result_query=mysqli_query($con,$select_query);
...
function total_cart_price()
{
  ...
  $get_ip = getIPAddress();
  $total_price=0;
  $cart_query="Select * from `cartdetails` where ip_address='$get_ip'";
